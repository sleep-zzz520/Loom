Loom 0.1.2 包含待办、日历、备忘录、邮箱、音乐、资料和 Agent 工作台；本次调整了设置页的信息层级与文案密度。

## 下载与安装

- Windows x64：下载 `Loom-Setup-0.1.2-x64.exe` 并按安装向导操作。支持应用内检查更新，下载与重启安装均由用户确认。
- macOS Apple Silicon：下载 `Loom-0.1.2-arm64.dmg`，将 Loom 拖入“应用程序”。要求 macOS 13 或更新版本；Intel Mac 暂无对应安装包。
