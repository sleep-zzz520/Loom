...
- Windows x64：下载 `Loom-Setup-0.1.1-x64.exe` 并按安装向导操作。支持应用内检查更新，下载与重启安装均由用户确认。
- macOS Apple Silicon：下载 `Loom-0.1.1-arm64.dmg`，将 Loom 拖入“应用程序”。要求 macOS 13 或更新版本；Intel Mac 暂无对应安装包。
